...
<div class="wrapper">
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4" >
    ...
    <a href="receptionist" class="brand-link">
      <img src="<?php echo e(asset('admin/dist/img/AdminLTELogo.png')); ?>" alt="AdminLTE Logo" class="brand-image img-circle elevation-3"
           style="opacity: .8">
      <span class="brand-text font-weight-light" style="color:#ffc107;font-weight:bold !important">Receptionist</span>
    </a>
  ...
  <footer class="main-footer" style="background: #393b3d">
    <strong>Copyright &copy; 2021 Open Source Team <a href="#" style="color:#ffc107">ITI</a>.</strong>
    All rights reserved.
...
<?php /**PATH /opt/lampp/htdocs/HotelMS/resources/views/receptionist/app.blade.php ENDPATH**/ ?>