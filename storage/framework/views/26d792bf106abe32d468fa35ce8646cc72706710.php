...
<div class="card">
    <div class="front">
     ...
     <div class="clickback">
        <a href="/admin/manageManager/index">Go Back</a>
     </div>
   </div>
     
 <?php $__env->stopSection(); ?>
<?php echo $__env->make('admin.manageManager.header', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /opt/lampp/htdocs/HotelMS/resources/views/admin/manageClient/show.blade.php ENDPATH**/ ?>